...
const SelectedItem = ({ item, onRemoveItem, disabled }) => (
...
export const SelectedItems = ({ items, onRemoveItem, disabled }) =>
  items.map((item) => (
    <SelectedItem key={item.value} item={item} onRemoveItem={onRemoveItem} disabled={disabled} />
  ));
